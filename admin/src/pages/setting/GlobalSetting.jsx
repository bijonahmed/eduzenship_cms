...
const GlobalSetting = () => {
  ...
  const [whatsAppTwo, setWhatsAppTwo] = useState("");
  const [whatsAppThree, setWhatsAppThree] = useState("");
  ...
  const handleConfigWhatsAppNumTwo = (e) => {
    setWhatsAppTwo(e.target.value);
  };

  const handleConfigWhatsAppNumThree = (e) => {
    setWhatsAppThree(e.target.value);
  };
 ...
 const defaultFetch = async () => {
    try {
      ...
      setWhatsAppTwo(userData.whatsAppTwo || "");
      setWhatsAppThree(userData.whatsAppThree || "");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("whatsAppTwo", whatsAppTwo);
      formData.append("whatsAppThree", whatsAppThree);
                      ...
                      <div className="col-sm-9">
                        <div className="position-relative">
                          <input
                            ...
                            value={whatsAppTwo}
                            onChange={handleConfigWhatsAppNumTwo}
                          />
                      ...
                      <div className="col-sm-9">
                        <div className="position-relative">
                          <input
                            ...
                            value={whatsAppThree}
                            onChange={handleConfigWhatsAppNumThree}
                          />
